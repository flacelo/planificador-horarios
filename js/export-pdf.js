...
(function() {
  ...
  function clonarVistaVisible(el) {
    ...
    // v7.81: clonación LIMPIA de la vista semanal - se eliminan TODAS las inyecciones forzadas de thead/tr/th y divs de cabecera.
    // La fila superior de días del clon permanece visible y alineada únicamente vía CSS de impresión (@media print).
    // Los botones de borrado/edición (.btn-remove, .remove-btn, .btn-delete, etc.) ya fueron removidos arriba (v7.30-v7.33).
